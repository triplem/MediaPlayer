    ...
    public void run() {
        ...
        while (isRunning()) {
            ...
            if (full_title != null && !current_title.equalsIgnoreCase(full_title)) {
                ...
                ev.setTitle(full_title);
                fireEvent(ev);
                current_title = full_title;
            }
            String artist = res.get("Artist");
            if (artist != null && !current_artist.equalsIgnoreCase(artist)) {
                EventUpdateTrackMetaText ev = new EventUpdateTrackMetaText();
                ev.setTitle(artist);
                fireEvent(ev);
                current_artist = artist;
            }
            String genre = res.get("Genre");
            if (genre != null && !current_genre.equalsIgnoreCase(genre)) {
                EventUpdateTrackMetaText ev = new EventUpdateTrackMetaText();
                ev.setTitle(genre);
                fireEvent(ev);
                current_genre = genre;
